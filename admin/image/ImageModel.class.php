...
class ImageModel extends Model
{
    ...
    */
     ...
     */
    public function uploadImg($inputName, $path, $appliedTable, $generateThumbnail = true, $maxThumbnailFileSize = 600000, $maxThumbnailLength = 350, $maxFileSize = 1000000, $maxLength = 1000) {
