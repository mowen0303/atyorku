                ...
                <table class="tab">
                    ...
                    foreach ($questions as $question) {
                        ...
                        <tr>
                            ...
                            <td><a href="/admin/courseQuestion/index.php?s=addQuestion&question_id=<?php echo $question['id'] ?>&course_code_id=<?php echo $course_code_id?>&prof_id=<?php echo $prof_id?>">更改</a></td>
                        </tr>
                        <?php
                    }
                    ?>
