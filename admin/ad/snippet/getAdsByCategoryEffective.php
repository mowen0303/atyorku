...
?>
    ...
    <nav class="mainNav">
        ...
        <a class="btn" href="/admin/ad/index.php?s=getAdsByCategoryIneffective&ad_category_id=<?php echo $ad_category_id ?>&ad_category_title=<?php echo $ad_category_title?>">未生效或过期的广告</a>
        ...
        <form action="AdController.php?action=deleteAd" method="post">
            <section>
                <table class="tab">
                    ...
                    <tbody>
                    <?php
                    $arr = $adModel->getAdsByCategory($ad_category_id,"effective");
                    foreach ($arr as $row) {
                        ?>
                        <tr>
