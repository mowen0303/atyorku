...
$id = BasicTool::get("id");
$row = $id?$courseRatingModel->getCourseRatingById($id,true):[];
$userID = $row['user_id']?:$userModel->userId;
?>
        ...
        <section class="formBox">
            ...
            <div id="courseCodeInputComponent" class="row">
                <div class="col-2">
                    ...
                    <input id="parentInput" class="input" type="text" list="parentCodeList" name="course_code_parent_title" value="<?php echo $row['course_code_parent_title']?>">
                    <datalist id="parentCodeList"></datalist>
                </div>
                <div class="col-2">
                    <label>课程代码 (例如:1000)<i>*</i></label>
                    <input id="childInput" class="input" type="text" list="childCodeCodeList" name="course_code_child_title" value="<?php echo $row['course_code_child_title']?>">
            ...
            <div id="professorInputComponent">
                <div>
                    <label>教授<i>*</i></label>
                    <input class="input" type="text" list="professorList" name="prof_name" value="<?php echo $row['prof_name'] ?>" />
            ...
            <div class="row">
                ...
                <div class="col-3">
                    ...
                    <select class="input input-select selectDefault" name="content_diff" defvalue="<?php echo $row['content_diff'] ?>">
                ...
                <div class="col-3">
                    <label>作业难度</label>
                    <select class="input input-select selectDefault" name="homework_diff" defvalue="<?php echo $row['homework_diff'] ?>">
                ...
                <div class="col-3">
                    <label>考试难度</label>
                    <select class="input input-select selectDefault" name="test_diff" defvalue="<?php echo $row['test_diff'] ?>">
            ...
            <div class="row">
                <div class="col-3">
                    <label>本门成绩</label>
                    <select class="input input-select selectDefault" name="grade" defvalue="<?php echo $row['grade'] ?>">
            ...
            <div class="row">
                <div class="col-2">
                    ...
                    <select class="input input-select selectDefault" name="year" defvalue="<?php echo $row['year'] ?>">
                        <?php
                ...
                <div class="col-2">
                    ...
                    <select class="input input-select selectDefault" name="term" defvalue="<?php echo $row['term'] ?>">
            ...
            <div>
                ...
                <textarea class="input input-textarea" name="comment" placeholder="点评下这个教授吧，例如：课讲的好不好，有没有口音，出题难不难，阅卷严不严，推不推荐，等等"><?php echo $row['comment'] ?></textarea>
            </div>
