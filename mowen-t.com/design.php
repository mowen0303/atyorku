...
<?
//查询img_list
$query = $db->select("imglist","id","status='1' AND c_id='3' order by imglist.time DESC,imglist.id DESC");
...
<div id="container">
  ...
  <div id="menuBox">
    ...
    <div id="m4" class="menu m4 hover">设计</div>
    <div id="m5" class="menu m5">关于</div>
  </div>
  <!--menu e-->
  <div class="secondCon" id="design">
    <div id="secondTit">
      <div></div>
    </div>
