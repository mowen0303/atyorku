...
//////////////////////////////////////	
	...
	function myinfoAct(v){
			
		v.hover(function(){
			clearTimeout(infoT);
			infoT = setTimeout(function(){myinfo("out")},infoTimeout)
		},function(){
			clearTimeout(infoT);
			infoT = setTimeout(function(){myinfo("in")},infoTimeout)
		})
	}
...
//////////////////////////////////////	
	...
	var m2_steep = 200;               //背景滑块滑动速度
	var m2_time  = 100;               //背景滑块自动回位时间
	var m2Bg_x_e = false;
	...
	menuCur("business","mene2_4");
	menuCur("message","mene2_5");

	
	m2Bg.css({"left":+m2Bg_x_e+"px"}).fadeIn("fast");
