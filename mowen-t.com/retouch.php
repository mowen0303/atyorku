...
<?
//查询img_list
$query = $db->select("imglist","id","status='1' AND c_id='2' order by imglist.time DESC,imglist.id DESC");
...
{
?>
$('.fancybox_<? echo $v ?>').fancybox({openEffect:'none',closeEffect:'none',prevEffect:'none',nextEffect:'none',closeBtn:false,helpers:{title:{type:'inside'},buttons:{}},afterLoad:function(){this.title=(this.index+1)+' / '+this.group.length+(this.title?' - '+this.title:'')}});
<?
}
?>
});
...
<div id="container">
  ...
  <!--menu e-->
  <div class="secondCon" id="retouch">
    <div id="secondTit">
      <div></div>
    </div>
		...
		?>
          ...
          <div class="imgBoxBg">
			...
			?>                
                ...
                <div class="imgtxt">
                	<div class="top"><? echo $query_a_title ?></div>
                    <div class="bot"><span class="s1"><? echo $query_a_author ?></span><span class="s2"><? echo $query_a_unm ?></span></div>
                </div>
