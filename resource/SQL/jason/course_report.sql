...
ALTER TABLE `course_report`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uc_course_report_course_code` (`course_code_id`) USING BTREE;
...
--
-- AUTO_INCREMENT for table `course_report`
--
ALTER TABLE `course_report`
...
--
ALTER TABLE `course_report`
  ADD CONSTRAINT `fk_course_report_course_code` FOREIGN KEY (`course_code_id`) REFERENCES `course_code` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
