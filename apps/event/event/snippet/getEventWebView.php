...
<head>
    ...
    <style>
        ...
        *:focus{outline:none}
        ...
        .detailLink { display: block; width: 80%; margin: 20px auto; text-align: center; background:#c91448; border-radius: 30px; padding:10px; color: #fff}
    </style>
</head>
<body>
<div id="container">
    ...
    <article>
        ...
        <?php
        if($event['detail_url']){
            echo '<a class="detailLink" href="'.$event['detail_url'].'" target="_blank">活动详情</a>';;
        }
        ?>
    </article>
</div>
