...
<head>
    ...
    <meta charset="UTF-8">
    <title><?php echo $arr['title'] ?> - AtYorkU</title>
    <link href="/apps/templete/article/css.css?07122" rel="stylesheet" type="text/css">
    <style type="text/css">
    ...
    <script>
        ...
        function timeLine(){
            wx.onMenuShareTimeline({
                ...
                imgUrl: 'http://www.atyorku.ca/resource/img/icon.png',
...
<article id="container">
    <div id="coverImgBox"><img src="http://www.atyorku.ca/resource/img/logo.jpg"></div>
    ...
    <hr>
    <p>&nbsp;</p>
    <p><img src="http://www.atyorku.ca/uploads/guide/images/ad3.jpg"></p>
    <p>&nbsp;</p>
    <hr>
    <p class="viewBox"><span>浏览量（<?php echo $arr['view_no']; ?>）</span></p>
</article>
<!-- <div style="display: block; padding-bottom: 58px; background:#888"><img style="width: 100%; height: auto; display: block" src="/resource/img/b1.jpg"><img style="width: 100%; height: auto; display: block" src="/resource/img/b2.jpg"><img style="width: 100%; height: auto; display: block" src="/resource/img/b3.jpg"></div> -->
